...
// Vérification online sur le serveur central (smart-shule-seven.vercel.app/api/license/verify).
...
// URL du serveur central de vérification des licences
const LICENSE_SERVER_URL = 'https://smart-shule-seven.vercel.app'
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="p-3 bg-blue-50 dark:bg-blue-950/30 rounded-md text-xs text-blue-700 dark:text-blue-300">
                ...
                <br />
                Contactez SmartShule au +243 999 071 754 ou visitez smart-shule-seven.vercel.app
              </div>
            </CardContent>
          </Card>
        )}
